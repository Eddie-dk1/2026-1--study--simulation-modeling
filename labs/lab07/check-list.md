Список элементов (чек-лист) для загрузки лабораторных работ 
Содержание
...
Ссылка на релиз друга как он выполнил эту ЛР7
https://github.com/JaferIdrisov/2026-1--study--simulation-modeling/releases/tag/lab07