...
function main()
    ...
    println("Saved: $(datadir("dining_classic.csv"))")
    println("Saved: $(datadir("dining_arbiter.csv"))")
    println("Saved: $(plotsdir("classic_simulation.png"))")
    println("Saved: $(plotsdir("arbiter_simulation.png"))")
end
